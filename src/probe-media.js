...
import {odoklassnikiHeaderBandAid, removeRangeBandAid, headerMatchName, USER_AGENT, REFERER_RGX} from "./config.js";
...
const
    ...
    // ---------------------------------------------------------------------------------
    fetchMediaUrl = url => new Promise(resolve => {
        const
            // create instance
            curl = new Curl();
    ...
    // ---------------------------------------------------------------------------------
    probeMediaUrl = (referer, origUrl, resolvedUrl, progBar) => new Promise(resolve => {
        // probe media source ...
        ffmpeg
