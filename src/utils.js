...
const
    ...
    {CLI_PROBE_COLOR, CLI_SAVE_COLOR, MEDIA_MIN_DURATION, MEDIA_MIN_STREAMS, DEFAULT_DOWNLOAD_DIR, PATH_RGX, ISOLATION_RGX} = config,
    // ---------------------------------------------------------------------------------
...
export {numSort, alphaSort, extractUrls, confirmDownloads, megadownload, output, logger};